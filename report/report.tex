...
The \textit{AI Risks \& Data Sources} block in the diagram expresses this shift. Responsible AI begins before model training, when the team identifies legitimate data sources, potentially under-represented groups, and risks, that must condition the \textit{Value Elicitation} block.
